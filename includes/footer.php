...
<h3>Real Tony Enterprise</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Real Tony Enterprise deals with all kinds of prints; as well as real estate issues</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
                ...
                <div class="media-body">
                    <p>Kodie Apagya, Off Offinso Road</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">realtonyenterprise@gmail.com</a></span>
                </div>
            </li>
